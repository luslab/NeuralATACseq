#/*==========================================================================#*/
#' ## Plot Shh loci - Anterior example (Figure 2B)
#+ chunk_regionPlots_Shh, cache=T, echo=F, warning=F, message=F
#/*==========================================================================#*/
...
promoter.inter <- subsetByOverlaps(promoter.inter, regions.promoter) #[abs(regions.promoter$distanceToTSS) > 2000])
