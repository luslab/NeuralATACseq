#/*==========================================================================#*/
#' ## Plot Phox2b loci - Cdx2 binding example (Figure S5A')
#+ chunk_regionPlots_Phox2bCdx2, cache=T, echo=F, warning=F, message=F
#/*==========================================================================#*/
...
promoter.region <- GRanges(seqnames = 'chr5', IRanges(67081352, 67127897))
