#/*==========================================================================#*/
#' ## Plot Hoxc8 loci - Spinal cord example (Figure 2D)
#+ chunk_regionPlots_Hoxc8, cache=T, echo=F, warning=F, message=F
#/*==========================================================================#*/
...
promoter.region <- GRanges(seqnames = 'chr15',
                           ranges = IRanges(102974935, 103037119))
